...
\newcommand{\Lang}{\mathbf{L}} % I think I should just change $\Lang$ to $L$ to make things consistent throughout the document... wdyt? Or replace all $L$ with $\L$ and define $\L$ to be $\Lang$ as below...
% \newcommand{\L}{\Lang}
\newcommand{\Funcs}{\mathbf{F}}
\newcommand{\Rels}{\mathbf{R}}
\newcommand{\Consts}{\mathbf{C}}

\newcommand{\Term}{\mathbf{Term}}
\newcommand{\AFml}{\mathbf{AFml}}
\newcommand{\Fml}{\mathbf{Fml}}
\newcommand{\Sent}{\mathbf{Sent}}
\newcommand{\FV}[1]{\mathbf{FV}\of{#1}}
...
\newcommand{\ACA}{Axiom of Choice}
\newcommand{\LSA}{Löwenheim-Skolem Axiom}

\newcommand{\PA}{\mathbf{PA}}
\newcommand{\TA}{\mathbf{TA}}

\newcommand{\card}[1]{\operatorname{card}\of{#1}}

\newcommand{\CD}{\mathbf{CD}}
\newcommand{\ED}{\mathbf{ED}}

\newcommand{\Lomo}{L_{\omega_1, \omega}}
\newcommand{\Lo}[1]{L_{#1, \omega}}
\newcommand{\Lop}[1]{L_{{#1}^{+}, \omega}}

\newcommand{\dg}{^{\dagger}}

\newcommand{\Erdos}{Erd\H{o}s}

% Teresa - feel free to add shortcuts here!
