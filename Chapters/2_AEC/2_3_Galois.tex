...
\begin{proof}
    ...
    \begin{description}
        ...
        \begin{align*} % What is \mathbb{P}(thing)? Oh power set
    ...
    %I appreciate that, but think I'm alright (thank you very much though) (and thank you for the notes :,))) (haha- and thank you for that, and you as well)
        % I have some ginger ale if you'd like a sugar fix. (It's caffeine-free though, unfortunately.)
        % Hope you manage to sleep well tonight
        %lmao (very nice for you (insert a satisfied face)) - in other words, sounds good/I see
        % You should know I have initiated the process to formally drop model theory
        %hey we still have topology
        %(of course) absolutely no worries at all (and I would be very happy if stopping the course takes a load off your back...here's hoping)
        % I hope you do enjoy the remainder of the course. I know we said we'd take a course together, so I do feel bad, but I'll be here for most of the course anyway
        % And yes we do - what course could be more fun?
        %oh that sounds fantastic
        % That it definitely will. All that remains now is to have a very frank, very French conversation about linear algebra homework, and the spheres will finally breathe a sigh of relief because THEY WILL THEN GET PACKED!!!!!
        %\(*u*)/ (or something like that)
        %...also this probably/hopefully goes without saying, but please don't feel compelled to take notes :) (: (also thanks for keeping me awake)
        % (It's not like I'm taking any right now...)
        %how very true...(or will I nap...(probably not))
        % Oh happy to help! Only if you aren't falling asleep will you be able to follow your nose in the next lecture :))
        \sorry
    \end{description}
\end{proof}
